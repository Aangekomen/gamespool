...
<div class="max-w-md mx-auto">
    ...
    <p class="text-slate-500 text-sm mb-6">Geef het apparaat een naam en koppel het spel.</p>
    ...
    <form method="post" action="<?= e($action) ?>" class="space-y-4 bg-white p-5 rounded-xl border border-slate-200 shadow-card">
        ...
        <div>
            <label class="block text-sm font-medium text-navy mb-1.5" for="location">Locatie <span class="text-slate-400">(optioneel)</span></label>
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <a href="<?= e(url('/admin/devices')) ?>" class="px-4 py-3 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700">Annuleren</a>
        </div>
    </form>
</div>
