...
<div class="max-w-md mx-auto">
    ...
    <h1 class="text-2xl font-bold text-navy mt-2 mb-1">Maak een nieuw team aan</h1>
    <p class="text-slate-500 text-sm mb-4">
        Geef je team een naam. Je krijgt automatisch een unieke
        <strong class="text-navy">6-cijferige join-code</strong> waarmee anderen
    ...
    <form method="post" action="<?= e(url('/teams')) ?>"
        ...
        <?= csrf_field() ?>
        <label for="name" class="block text-sm font-medium text-navy mb-2">Teamnaam</label>
