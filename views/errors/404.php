...
<div class="text-center py-20">
    ...
    <a href="<?= e(url('/')) ?>" class="inline-block mt-6 px-4 py-2 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 text-navy dark:text-slate-100">Naar home</a>
</div>
